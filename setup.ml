...
(* OASIS_START *)
(* DO NOT EDIT (digest: cee789430443473f21e29f924bac04af) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/rizo/ocaml-nanovg";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-lnanovg_gl3"])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "nanovg";
                           FindlibPackage ("glfw", None);
                           FindlibPackage ("tgls.tgl3", None);
                   ...
                   {exec_custom = false; exec_main_is = "test_nanovg.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/rizo/ocaml-nanovg.git";
                      src_repo_browser =
                        Some "https://github.com/rizo/ocaml-nanovg";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "D6b\219*\191\156\127\208\192\141\028Eh\227\159";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
